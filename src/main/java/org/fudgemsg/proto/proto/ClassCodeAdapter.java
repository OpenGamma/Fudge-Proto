...
public abstract class ClassCodeAdapter extends BlockCodeAdapter implements ClassCode {
  ...
  @Override
  public void writeHeaderFileHeader (final Compiler.Context context, final File targetFile, final IndentWriter writer, final String autoGeneratedHeaderComment) throws IOException {
    _delegate.writeHeaderFileHeader (context, targetFile, writer, autoGeneratedHeaderComment);
  }
  ...
  @Override
  public void writeImplementationFileHeader (final Compiler.Context context, final File targetFile, final IndentWriter writer, final String autoGeneratedHeaderComment) throws IOException {
    _delegate.writeImplementationFileHeader (context, targetFile, writer, autoGeneratedHeaderComment);
  }
