...
public abstract class HeaderlessClassCode extends ClassCodeAdapter {
  ...
  @Override
  public final void writeHeaderFileHeader (final Compiler.Context context, final File targetFile, final IndentWriter writer, final String autoGeneratedHeaderComment) throws IOException {
    // deliberate no-op
  }
