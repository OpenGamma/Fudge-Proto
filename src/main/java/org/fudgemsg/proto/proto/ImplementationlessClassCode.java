...
public abstract class ImplementationlessClassCode extends ClassCodeAdapter {
  ...
  @Override
  public final void writeImplementationFileHeader (final Compiler.Context context, final File targetFile, final IndentWriter writer, final String autoGeneratedHeaderComment) throws IOException {
    // deliberate no-op
  }
