...
public class CCodeGenerator extends ClassCodeGenerator {
  ...
  @Override
  public void writeHeaderFileHeader(final Compiler.Context context, final File header, final IndentWriter writer, final String autoGeneratedHeaderComment)
      throws IOException {
    writeInclude(writer);
    super.writeHeaderFileHeader(context, header, writer, autoGeneratedHeaderComment);
    writeTCharDefs(writer);
  }

  @Override
  public void writeImplementationFileHeader(final Compiler.Context context, final File file, final IndentWriter writer, final String autoGeneratedHeaderComment)
      throws IOException {
    writeInclude(writer);
    super.writeImplementationFileHeader(context, file, writer, autoGeneratedHeaderComment);
    writeTCharDefs(writer);
