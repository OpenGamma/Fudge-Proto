...
/* package */class CClassCode extends CStyleClassCode {
  ...
  @Override
  public void writeHeaderFileHeader(final Compiler.Context context, final File targetFile, final IndentWriter writer, final String autoGeneratedHeaderComment)
      throws IOException {
    super.writeHeaderFileHeader(context, targetFile, writer, autoGeneratedHeaderComment);
  ...
  public void writeImplementationFileHeader(final Compiler.Context context, final File targetFile,
      final IndentWriter writer, final String autoGeneratedHeaderComment) throws IOException {
    super.writeImplementationFileHeader(context, targetFile, writer, autoGeneratedHeaderComment);
